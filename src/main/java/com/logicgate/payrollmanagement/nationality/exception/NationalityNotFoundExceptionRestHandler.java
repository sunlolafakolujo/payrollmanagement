...
public class NationalityNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(NationalityNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> nationalityNotFoundException(NationalityNotFoundException nnfe,
                                                                             WebRequest request) {
