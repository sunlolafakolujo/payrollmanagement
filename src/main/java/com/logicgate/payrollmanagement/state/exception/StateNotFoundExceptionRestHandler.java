...
public class StateNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(StateNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> stateNotFoundException(StateNotFoundException snfe, WebRequest request) {
