...
public class JobGroupNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(JobGroupNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> jobGroupNotFoundException(JobGroupNotFoundException jgnfe,
                                                                          WebRequest request) {
